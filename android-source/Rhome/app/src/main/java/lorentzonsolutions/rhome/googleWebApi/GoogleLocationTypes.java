...
public enum GoogleLocationTypes {
    ...
    CAR_WASH("car_wash", "Car Wash"), CASINO("casino", "Casino"), CEMETERY("cemetery", "Cemetery"), CHURCH("church", "Church"), CITY_HALL("city_hall", "City Hall"),
    CLOTHING_STORE("clothing_store", "Clothing Store"), CONVENIENCE_STORE("convenience_store", "Convenience Store"), COURTHOUSE("courthouse", "Courthouse"), DENTIST("dentist", "Dentist"),
