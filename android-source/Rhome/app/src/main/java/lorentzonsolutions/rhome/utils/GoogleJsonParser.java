...
public class GoogleJsonParser implements WebApiResponseJsonParser{
    ...
    private GooglePlace buildNearbyPlaceInformation(JSONObject placeObject) {
        ...
        try {
            ...
            Location start = SessionStorage.INSTANCE.getSelectedStartLocation();
            Location end = SessionStorage.INSTANCE.getSelectedEndLocation();
            if(start != null) {
        ...
        GooglePlace result = new GooglePlace.BuildPlace(name, latitude, longitude)
                ...
                .minutesByCarToEndLocation(durationByCarToEndLocation)
